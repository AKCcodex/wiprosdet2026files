...
public class tc_bank_TestNG 
{
    ...
    public void reg() throws InterruptedException{
   	 ...
   	 driver.findElement(By.id("customer.username")).sendKeys("Ashish1234573");
   	 ...
   	 Thread.sleep(4000);
     String transferMessage = driver.findElement(By.xpath("//*[@id=\"rightPanel\"]/p")).getText();

     Assert.assertEquals(transferMessage, "Your account was created successfully. You are now logged in.");
    ...
    public void loginTest() throws InterruptedException
    {
        ...
        String transferMessage = driver.findElement(By.xpath("/html/body/div[1]/div[3]/div[2]/div/div[1]/h1")).getText();

        Assert.assertEquals(transferMessage, "Accounts Overview");
    ...
    public void opennew() throws InterruptedException
    {
        ...
        String transferMessage = driver.findElement(By.xpath("/html/body/div[1]/div[3]/div[2]/div/div[2]/p[1]")).getText();

        Assert.assertEquals(transferMessage, "Congratulations, your account is now open.");
